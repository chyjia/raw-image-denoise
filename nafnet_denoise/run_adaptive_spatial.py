"""P1b: adaptive spatial Wiener (stronger on flats / dark) + short FT."""
...
def main() -> None:
    ...
    out_dir = Path("nafnet_denoise/checkpoints_4f_adaptive_spatial")
    compare_dir = Path("nafnet_denoise/compare_adaptive_spatial")
    ...
    if not args.skip_train:
        ...
        cmd = [
            ...
            "--wiener-spatial-flat-c-mult", "3.0",
            "--wiener-spatial-dark-boost", "0.75",
            "--wiener-bm3d-teacher",
            ...
            "--hard-des-sigma-mult", "2.0",
            "--hard-des-hp-weight", "0.40",
