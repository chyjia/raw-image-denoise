"""Fine-tune dual-head+NL with train-time align soft-gate; compare with gated infer."""
...
def main() -> None:
    ...
    parser.add_argument("--align-drop-prob", type=float, default=0.10)
    ...
    out_dir = Path("nafnet_denoise/checkpoints_4f_align_gated_train")
    compare_dir = Path("nafnet_denoise/compare_align_gated_train")
    ...
    if not args.skip_train:
        ...
        cmd = [
            ...
            "--align-drop-prob", str(args.align_drop_prob),
