"""FT DualHead with learnable burst merge + multi-frame flat teacher; gated DES."""
...
def main() -> None:
    ...
    out_dir = Path("nafnet_denoise/checkpoints_4f_burst_merge")
    compare_dir = Path("nafnet_denoise/compare_burst_merge")
