"""Fine-tune DN-domain Dual+NL with deformable align; gated DES compare."""
...
def main() -> None:
    ...
    out_dir = Path("nafnet_denoise/checkpoints_4f_deformable")
    compare_dir = Path("nafnet_denoise/compare_deformable")
