"""Fine-tune flat-boost with DES-aligned flat σ / noise-gain loss; gated compare."""
...
def main() -> None:
    ...
    out_dir = Path("nafnet_denoise/checkpoints_4f_des_align")
    compare_dir = Path("nafnet_denoise/compare_des_align")
