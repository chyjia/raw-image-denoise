"""Chain P120+ DES cycles; early-stop after consecutive no-bake (default 5)."""
...
MODULES = [
    ("120", "nafnet_denoise.run_des_meta100_p120"),
    ("121", "nafnet_denoise.run_des_meta100_p121"),
    ("122", "nafnet_denoise.run_des_meta100_p122"),
    ("123", "nafnet_denoise.run_des_meta100_p123"),
]

EXTRA_TEMPLATES = [
    "run_des_meta100_p120.py",
    "run_des_meta100_p121.py",
    "run_des_meta100_p122.py",
    "run_des_meta100_p123.py",
]


def current_baseline(root: Path) -> float:
    for cyc in range(150, 39, -1):
    ...
    return float(m.group(1)) if m else 0.9528
...
def main() -> None:
    ...
    log_path = log_dir / "cycle_log_p120plus.jsonl"
