"""Chain P126+ DES cycles; early-stop after consecutive no-bake (default 5)."""
...
MODULES = [
    ("126", "nafnet_denoise.run_des_meta100_p126"),
    ("127", "nafnet_denoise.run_des_meta100_p127"),
    ("128", "nafnet_denoise.run_des_meta100_p128"),
    ("129", "nafnet_denoise.run_des_meta100_p129"),
]

EXTRA_TEMPLATES = [
    "run_des_meta100_p126.py",
    "run_des_meta100_p127.py",
    "run_des_meta100_p128.py",
    "run_des_meta100_p129.py",
]


def current_baseline(root: Path) -> float:
    for cyc in range(200, 39, -1):
    ...
    return float(m.group(1)) if m else 0.9556
...
def main() -> None:
    ...
    log_path = log_dir / "cycle_log_p126plus.jsonl"
    chain_log = log_dir / "chain_p126plus.log"
