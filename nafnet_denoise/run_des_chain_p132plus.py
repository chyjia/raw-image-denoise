"""Chain P132+ DES cycles; early-stop after consecutive no-bake (default 5)."""
...
MODULES = [
    ("132", "nafnet_denoise.run_des_meta100_p132"),
    ("133", "nafnet_denoise.run_des_meta100_p133"),
    ("134", "nafnet_denoise.run_des_meta100_p134"),
    ("135", "nafnet_denoise.run_des_meta100_p135"),
]

EXTRA_TEMPLATES = [
    "run_des_meta100_p132.py",
    "run_des_meta100_p133.py",
    "run_des_meta100_p134.py",
    "run_des_meta100_p135.py",
]


def current_baseline(root: Path) -> float:
    for cyc in range(220, 39, -1):
    ...
    return float(m.group(1)) if m else 0.9565
...
def main() -> None:
    ...
    log_path = log_dir / "cycle_log_p132plus.jsonl"
