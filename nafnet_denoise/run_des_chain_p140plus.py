"""Chain P140+ DES cycles; early-stop after consecutive no-bake (default 5)."""
...
MODULES = [
    ("140", "nafnet_denoise.run_des_meta100_p140"),
    ("141", "nafnet_denoise.run_des_meta100_p141"),
    ("142", "nafnet_denoise.run_des_meta100_p142"),
    ("143", "nafnet_denoise.run_des_meta100_p143"),
]

EXTRA_TEMPLATES = [
    "run_des_meta100_p140.py",
    "run_des_meta100_p141.py",
    "run_des_meta100_p142.py",
    "run_des_meta100_p143.py",
]


def current_baseline(root: Path) -> float:
    for cyc in range(250, 39, -1):
    ...
    return float(m.group(1)) if m else 0.9572
...
def main() -> None:
    ...
    log_path = log_dir / "cycle_log_p140plus.jsonl"
