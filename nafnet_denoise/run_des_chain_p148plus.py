"""Chain P148+ DES cycles; early-stop after consecutive no-bake (default 5)."""
...
MODULES = [
    ("148", "nafnet_denoise.run_des_meta100_p148"),
    ("149", "nafnet_denoise.run_des_meta100_p149"),
    ("150", "nafnet_denoise.run_des_meta100_p150"),
    ("151", "nafnet_denoise.run_des_meta100_p151"),
]
...
def current_baseline(root: Path) -> float:
    ...
    return float(m.group(1)) if m else 0.9580
