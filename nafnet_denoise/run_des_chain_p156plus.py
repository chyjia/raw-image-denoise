"""Chain P156+ DES cycles; early-stop after consecutive no-bake (default 5)."""
...
MODULES = [
    ("156", "nafnet_denoise.run_des_meta100_p156"),
    ("157", "nafnet_denoise.run_des_meta100_p157"),
    ("158", "nafnet_denoise.run_des_meta100_p158"),
    ("159", "nafnet_denoise.run_des_meta100_p159"),
]

EXTRA_TEMPLATES = [
    "run_des_meta100_p156.py",
    "run_des_meta100_p157.py",
    "run_des_meta100_p158.py",
    "run_des_meta100_p159.py",
]


def current_baseline(root: Path) -> float:
    for cyc in range(280, 39, -1):
    ...
    return float(m.group(1)) if m else 0.9589
...
def main() -> None:
    ...
    log_path = log_dir / "cycle_log_p156plus.jsonl"
