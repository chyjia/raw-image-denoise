"""Chain P61+ DES cycles; early-stop after consecutive no-bake (default 5)."""
...
MODULES = [
    ("61", "nafnet_denoise.run_des_meta100_p61"),
    ("62", "nafnet_denoise.run_des_meta100_p62"),
    ("63", "nafnet_denoise.run_des_meta100_p63"),
    ("64", "nafnet_denoise.run_des_meta100_p64"),
]

EXTRA_TEMPLATES = [
    "run_des_meta100_p66.py",
    "run_des_meta100_p67.py",
    "run_des_meta100_p68.py",
    "run_des_meta100_p64.py",
]


def current_baseline(root: Path) -> float:
    for cyc in range(100, 39, -1):
...
def main() -> None:
    ...
    log_path = log_dir / "cycle_log_p61plus.jsonl"
