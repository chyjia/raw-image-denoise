"""Chain P80+ DES cycles; early-stop after consecutive no-bake (default 5)."""
...
MODULES = [
    ("80", "nafnet_denoise.run_des_meta100_p80"),
    ("81", "nafnet_denoise.run_des_meta100_p81"),
    ("82", "nafnet_denoise.run_des_meta100_p82"),
]

EXTRA_TEMPLATES = [
    "run_des_meta100_p80.py",
    "run_des_meta100_p81.py",
    "run_des_meta100_p82.py",
]
...
def main() -> None:
    ...
    log_path = log_dir / "cycle_log_p80plus.jsonl"
