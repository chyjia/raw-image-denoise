"""Chain P85+; early-stop after consecutive no-bake."""
...
MODULES = [("85", "nafnet_denoise.run_des_meta100_p85")]
EXTRA_TEMPLATES = ["run_des_meta100_p85.py"]
...
def main() -> None:
    ...
    log_path = log_dir / "cycle_log_p85plus.jsonl"
