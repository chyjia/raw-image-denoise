"""Chain P90+ DES cycles; early-stop after consecutive no-bake (default 5)."""
...
MODULES = [
    ("90", "nafnet_denoise.run_des_meta100_p90"),
    ("91", "nafnet_denoise.run_des_meta100_p91"),
    ("92", "nafnet_denoise.run_des_meta100_p92"),
    ("93", "nafnet_denoise.run_des_meta100_p93"),
]

EXTRA_TEMPLATES = [
    "run_des_meta100_p90.py",
    "run_des_meta100_p91.py",
    "run_des_meta100_p92.py",
    "run_des_meta100_p93.py",
]
...
def main() -> None:
    ...
    log_path = log_dir / "cycle_log_p90plus.jsonl"
