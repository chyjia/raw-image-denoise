"""P104: Anscombe fine-grid around P98 bake (s=0.2,k=0.5,sig=2,f50).
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("nafnet_denoise/compare_meta100_p104")
    )
