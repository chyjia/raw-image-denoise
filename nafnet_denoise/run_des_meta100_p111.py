"""P111: YOND CNE two-pass — residual MAD after P74 gates Anscombe.
...
def bake_fn(best: dict) -> None:
    Path("nafnet_denoise/deploy_p111_hook.json").write_text(
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("nafnet_denoise/compare_meta100_p111")
    )
