"""P113: Haar DWT cycle-spin shrink on flats after P103 (Parhi LSP'23 / EURASIP'25).
...
def bake_fn(best: dict) -> None:
    Path("nafnet_denoise/deploy_p113_hook.json").write_text(
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("nafnet_denoise/compare_meta100_p113")
    )
