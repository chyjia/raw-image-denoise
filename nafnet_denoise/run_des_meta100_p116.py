"""P116: YOND SNR-map — local MAD tiles gate Anscombe strength spatially.
...
def bake_fn(best: dict) -> None:
    Path("nafnet_denoise/deploy_p116_hook.json").write_text(
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("nafnet_denoise/compare_meta100_p116")
    )
