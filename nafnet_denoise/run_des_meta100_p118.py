"""P118: cycle-spin Anscombe on P103 gated params (Coifman–Donoho / EURASIP'25).
...
def bake_fn(best: dict) -> None:
    Path("nafnet_denoise/deploy_p118_hook.json").write_text(
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("nafnet_denoise/compare_meta100_p118")
    )
