"""P121: exposure-conditioned CNE-spin (AdaptiveISP × YOND CNE × Coifman).
...
def bake_fn(best: dict) -> None:
    Path("nafnet_denoise/deploy_p121_hook.json").write_text(
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("nafnet_denoise/compare_meta100_p121")
    )
