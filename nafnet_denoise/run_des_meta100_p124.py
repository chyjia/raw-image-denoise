"""P124: recursive cycle-spin Anscombe (EURASIP'25 modified recursive CS).
...
def bake_fn(best: dict) -> None:
    Path("nafnet_denoise/deploy_p124_hook.json").write_text(
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("nafnet_denoise/compare_meta100_p124")
    )
