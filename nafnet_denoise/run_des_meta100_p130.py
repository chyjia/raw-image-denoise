"""P130: EUI inverse on recursive CNE-spin (Makitalo–Foi TIP'12).
...
def bake_fn(best: dict) -> None:
    Path("nafnet_denoise/deploy_p130_hook.json").write_text(
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("nafnet_denoise/compare_meta100_p130")
    )
