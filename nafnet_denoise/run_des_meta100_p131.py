"""P131: interscale Haar shrink after P120 (Luisier Signal Processing'09).
...
def bake_fn(best: dict) -> None:
    Path("nafnet_denoise/deploy_p131_hook.json").write_text(
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("nafnet_denoise/compare_meta100_p131")
    )
