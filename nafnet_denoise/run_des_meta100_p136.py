"""P136: RPG-VST σz gate algebraic vs EUI recursive spin.
...
def bake_fn(best: dict) -> None:
    Path("nafnet_denoise/deploy_p136_hook.json").write_text(
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("nafnet_denoise/compare_meta100_p136")
    )
