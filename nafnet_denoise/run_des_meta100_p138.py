"""P138: SURE-lite k_mad selection on recursive EUI (Luisier TIP'07).
...
def bake_fn(best: dict) -> None:
    Path("nafnet_denoise/deploy_p138_hook.json").write_text(
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("nafnet_denoise/compare_meta100_p138")
    )
