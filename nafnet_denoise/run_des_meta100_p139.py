"""P139: DualDn-lite residual-domain Anscombe after EUI (ECCV'24 DualDn).
...
def bake_fn(best: dict) -> None:
    Path("nafnet_denoise/deploy_p139_hook.json").write_text(
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("nafnet_denoise/compare_meta100_p139")
    )
