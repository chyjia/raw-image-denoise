"""P143: PURE-lite intensity-weighted k pick (Luisier PURE / PG-URE lite).
...
def bake_fn(best: dict) -> None:
    Path("nafnet_denoise/deploy_p143_hook.json").write_text(
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("nafnet_denoise/compare_meta100_p143")
    )
