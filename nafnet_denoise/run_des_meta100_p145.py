"""P145: firm/semisoft shrinkage + SURE-k (Gao firm WaveShrink).
...
def bake_fn(best: dict) -> None:
    Path("nafnet_denoise/deploy_p145_hook.json").write_text(
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("nafnet_denoise/compare_meta100_p145")
    )
