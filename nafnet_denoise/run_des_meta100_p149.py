"""P149: wide-window NeighShrink (Chen 5×5 / 7×5 NeighSure).
...
def bake_fn(best: dict) -> None:
    Path("nafnet_denoise/deploy_p149_hook.json").write_text(
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("nafnet_denoise/compare_meta100_p149")
    )
