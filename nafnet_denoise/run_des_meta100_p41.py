"""P41: refine P31 fps bands + FE-aligned mid thresholds (zero-train).
...
def bake_fn(best: dict) -> None:
    ...
    Path("nafnet_denoise/deploy_p41_hook.json").write_text(
    ...
    print(f"Baked P41 {best['name']}", flush=True)
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("nafnet_denoise/compare_meta100_p41"))
