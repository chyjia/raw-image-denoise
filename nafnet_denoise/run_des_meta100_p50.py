"""P50: Pixel2Pixel/TTAD pixel-bank flat median (fast intensity-bin proxy).
...
def bake_fn(best: dict) -> None:
    ...
    Path("nafnet_denoise/deploy_p50_hook.json").write_text(
    ...
    note = Path("nafnet_denoise/compare_meta100_p50/BAKE_NOTE.txt")
    ...
    print(f"Wrote P50 hook {best['name']}", flush=True)
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        "--output-dir", type=Path, default=Path("nafnet_denoise/compare_meta100_p50")
