"""P53: intensity-bin EnsIR-lite fuse of SOTA↔edge arms then P40 schedule.
...
def bake_fn(best: dict) -> None:
    ...
    Path("nafnet_denoise/deploy_p53_hook.json").write_text(
    ...
    Path("nafnet_denoise/compare_meta100_p53").mkdir(parents=True, exist_ok=True)

    Path("nafnet_denoise/compare_meta100_p53/BAKE_NOTE.txt").write_text(
    ...
    print(f"Wrote P53 hook {best['name']}", flush=True)
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        "--output-dir", type=Path, default=Path("nafnet_denoise/compare_meta100_p53")
