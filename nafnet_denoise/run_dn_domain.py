"""Fine-tune align-gated Dual+NL with DN-domain distill loss; gated DES compare."""
...
def main() -> None:
    ...
    resume = Path("nafnet_denoise/checkpoints_4f_align_gated_train/best.pt")
    if not resume.exists():
        resume = Path("nafnet_denoise/checkpoints_4f_dual_head_nonlocal/best.pt")
    out_dir = Path("nafnet_denoise/checkpoints_4f_dn_domain")
    compare_dir = Path("nafnet_denoise/compare_dn_domain")
