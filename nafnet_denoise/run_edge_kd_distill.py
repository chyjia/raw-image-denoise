"""P0-b: distill low-σ specialist edges into split_edge_fid single DualHead.

Flat regions keep partitioned BM3D teacher; edges KD toward
``checkpoints_4f_spec_low`` (ef≈BM3D on f10). Resume from split_edge_fid.
"""
...
def main() -> None:
    ...
    parser.add_argument("--edge-kd-mix", type=float, default=0.85)
    ...
    out_dir = Path("nafnet_denoise/checkpoints_4f_edge_kd")
    compare_dir = Path("nafnet_denoise/compare_edge_kd")
