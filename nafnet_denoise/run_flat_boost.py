"""Strengthen flat-region distill on DN-domain Dual+NL; gated DES compare."""
...
def main() -> None:
    ...
    out_dir = Path("nafnet_denoise/checkpoints_4f_flat_boost")
    compare_dir = Path("nafnet_denoise/compare_flat_boost")
    ...
    if not args.skip_train:
        ...
        cmd = [
            ...
            "--lr", "5e-6",
            # Stronger flat / BM3D teacher emphasis vs DN-domain defaults.
