"""Second-round stronger flat distill on 4f flat-boost; gated DES compare."""
...
def main() -> None:
    ...
    out_dir = Path("nafnet_denoise/checkpoints_4f_flat_boost_v2")
    compare_dir = Path("nafnet_denoise/compare_flat_boost_v2")
    ...
    if not args.skip_train:
        ...
        cmd = [
            ...
            "--loss-domain", "dn",
            # Blend keeps some temporal on flats; high alpha still pulls toward BM3D.
            "--teacher-mode", "blend",
            ...
            "--lr", "4e-6",
            # Stronger flat pressure vs flat_boost v1.
            "--teacher-weight-start", "0.80",
            "--teacher-weight-end", "0.55",
            "--highpass-weight", "0.95",
            "--flat-boost", "4.5",
            "--flat-sigma-weight", "1.20",
