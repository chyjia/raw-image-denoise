"""Fine-tune DN-domain Dual+NL with learnable soft mask; gated DES compare."""
...
def main() -> None:
    ...
    out_dir = Path("nafnet_denoise/checkpoints_4f_learnable_mask")
    compare_dir = Path("nafnet_denoise/compare_learnable_mask")
