"""Calibrate post-merge residual σ, short FT DualHead, DES compare."""
...
def main() -> None:
    ...
    out_dir = Path("nafnet_denoise/checkpoints_4f_postmerge_sigma")
    compare_dir = Path("nafnet_denoise/compare_postmerge_sigma")
