"""Split teachers (flat=BM3D, edge=temporal) + DES edge_fidelity FT on f10."""
...
def main() -> None:
    ...
    out_dir = Path("nafnet_denoise/checkpoints_4f_split_edge_fid")
    compare_dir = Path("nafnet_denoise/compare_split_edge_fid")
    ...
    if not args.skip_train:
        ...
        cmd = [
            ...
            # Key: pure partition + sharpened edge mask (no BM3D on edges).
