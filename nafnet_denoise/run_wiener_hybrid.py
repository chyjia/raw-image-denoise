"""FT DualHead on temporal+spatial HDR+ Wiener inputs; DES compare."""
...
def main() -> None:
    ...
    resume = Path("nafnet_denoise/checkpoints_4f_wiener_spatial/best.pt")
    if not resume.exists():
        resume = Path("nafnet_denoise/checkpoints_4f_des_align/best.pt")
    out_dir = Path("nafnet_denoise/checkpoints_4f_wiener_hybrid")
    compare_dir = Path("nafnet_denoise/compare_wiener_hybrid")
    ...
    if not args.skip_train:
        ...
        cmd = [
            ...
            "--real-fraction", "1.0",
            "--lr", "4e-6",
            "--teacher-weight-start", "0.60",
            "--teacher-weight-end", "0.35",
            "--highpass-weight", "0.65",
            "--flat-boost", "2.5",
            "--flat-sigma-weight", "0.60",
            "--des-flat-sigma-weight", "0.70",
            "--des-noise-gain-weight", "0.45",
