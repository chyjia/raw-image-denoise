"""FT DualHead spatial net on frozen HDR+ Wiener-merged inputs; DES compare."""
...
def main() -> None:
    ...
    resume = Path("nafnet_denoise/checkpoints_4f_des_align/best.pt")
    if not resume.exists():
        resume = Path("nafnet_denoise/checkpoints_4f_flat_boost_v2/best.pt")
    out_dir = Path("nafnet_denoise/checkpoints_4f_wiener_spatial")
    compare_dir = Path("nafnet_denoise/compare_wiener_spatial")
    ...
    if not args.skip_train:
        ...
        # Real-only: synthetic PixelShift bursts are not Wiener-preprocessed yet.
        cmd = [
            ...
            "--des-flat-sigma-weight", "0.80",
            "--des-noise-gain-weight", "0.50",
    ...
    if not args.skip_compare:
        ...
        # Full Wiener ablation-style compare with the FT spatial checkpoint.
        run(
            [
